...
#player movement
const SPEED = 12 * Globals.UNIT_SIZE
const ACCELARATION = 700
const FRICTION = 800
const AIR_RESISTANCE = 200
const AIR_ACCELARATION = 400
...
var WALL_JUMP_VELOCITY = Vector2(12 * Globals.UNIT_SIZE,-Globals.UNIT_SIZE * 20)
...
@export var climb_speed = Globals.UNIT_SIZE * 5.625 
